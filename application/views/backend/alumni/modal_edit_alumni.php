...
?>
        <div class="content bg-light" >
          <div class="container-fluid">
            <div class="row">
              <?php echo form_open_multipart('alumni/upload/'.$row['alumni_student_ID'], 'class="col-md-12"');?>
                <div class="col-md-12">
                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      <div class="tab-pane active" id="about">
                        <?php echo form_open('alumni/profile/edit_about/'.$row['alumni_student_ID'], 'class="login100-form validate-form col-md-12"','role="form"','id="form_login"'); ?>
                          <div class="row">
                            <div class="col-md-12">
                          ...
                          <div class="card-body">
                            <div class="tab-content">
                              ...
                              <div class="tab-pane active" id="work">
                                <?php  
                                  ...
                                  $query2 = $this->db->get()->result_array();
                                    foreach ($query2 as $row2):
                                ?>
                                  <?php echo form_open('alumni/profile/edit_work/'.$param1, 'class="login100-form validate-form"','role="form"','id="form_login"'); ?>
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group">
                              ...
                              <div class="tab-pane" id="add_work">
                                  <?php echo form_open('alumni/profile/create_work/'.$param1, 'class="login100-form validate-form col-md-12"','role="form"','id="form_login"'); ?>
                                    <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label class="bmd-label-floating">Position</label>

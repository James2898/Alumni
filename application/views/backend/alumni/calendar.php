    ...
    $('#calendar').fullCalendar({
      ...
      eventClick: function(event){
          ...
          if(appointment_ID != 'NULL'){
            showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_view_appointment/'+appointment_ID)
          }
      ...
      eventLimit: true,
      header: {
        left: 'prev next <?php echo $is_add; ?>',
        center: 'title',
      ...
      customButtons: {
        add: {
          text: 'Add',
          click: function() {
            showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_add_appointment/')
          },
        },
      },
      events: [
        ...
        ?>
              {
                <?php  
                  if($row['appointment_alumni_ID'] == $_SESSION['user_ID']){ 
                    echo "
                      title: '".$row['alumni_fname']."',
                      color: '".$color."',
                      id:  '".$row['appointment_ID']."',
                      start: '".$row['appointment_date_start']." ".$row['appointment_time_start']."',
                      end:  '".$row['appointment_date_end']." ".$row['appointment_time_end']."'
                    ";
                  }else{
                    echo "
                      title: 'Reserved',

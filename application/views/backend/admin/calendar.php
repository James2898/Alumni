      ...
      ?>
            {
              ...
              title  : '<?php echo $row['alumni_fname'] ?>',
              start  : '<?php echo $row['appointment_date_start']." ".$row['appointment_time_start']?>',
              end    : '<?php echo $row['appointment_date_end']." ".$row['appointment_time_end']?>',
